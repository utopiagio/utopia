...
// access.
func (l *GioSelectable) initialize() {
	if !l.initialized {
...
/*func (e *GioSelectable) processKey(gtx layout.Context) {
...
/*func (e *GioSelectable) command(gtx layout.Context, k key.Event) {
	direction := 1
...
/*func (l *GioSelectable) Events() []EditorEvent {
	events := l.events
	l.events = nil
	l.prevEvents = 0
	return events
